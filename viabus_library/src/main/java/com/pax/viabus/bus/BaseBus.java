...
public class BaseBus {
    ...
    public static void registerRequestHandler(IRequest request) {
        ...
        if (implementedInterface == null) {
            throw new IllegalStateException("Error: Please declare a request interface extends IRequest, and then make business class implement it.");
        }
    ...
    public static void response(Result result) {
        ...
        if (mIResponses != null && !mIResponses.isEmpty()) {
    ...
    protected static IRequest getRequest(Class iRequest) {
        ...
        if (iRequest1 == null) {
            throw new IllegalStateException("Error: Please register a request '" + iRequest.getSimpleName() + "' by bus");
        }
        return iRequest1;
    }
}
