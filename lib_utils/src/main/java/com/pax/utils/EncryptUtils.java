...
public class EncryptUtils {
    ...
    public static byte[] encryptMD5File(final File file) {
        ...
        try {
            ...
            Log.e(TAG, "encryptMD5File: ", e);
            return new byte[0];
        }
        try (FileInputStream fis = new FileInputStream(file); DigestInputStream digestInputStream = new DigestInputStream(fis, md)) {
     ...
     * @return the bytes of 3DES decryption for Base64-encode bytes
     */
    public static byte[] decryptBase643DES(final byte[] data,
                                           final byte[] key,
                                           final String transformation,
                                           final byte[] iv) {
