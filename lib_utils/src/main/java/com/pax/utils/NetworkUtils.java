...
public class NetworkUtils {
    ...
    private static final String NETWORK_ETHERNET = "NETWORK_ETHERNET";
    ...
    @StringDef({NETWORK_ETHERNET, NETWORK_WIFI, NETWORK_4G, NETWORK_3G, NETWORK_2G, NETWORK_UNKNOWN, NETWORK_NO})
    ...
    public static String getBroadcastIpAddress() {
        try {
            ...
            Log.e(TAG, "getBroadcastIpAddress: ", e);
        }
        return "";
    }
