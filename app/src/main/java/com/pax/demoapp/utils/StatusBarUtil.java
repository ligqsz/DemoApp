 ...
 * @date 2018/10/17
 */
@SuppressWarnings({"WeakerAccess", "unused", "Convert2Lambda", "Anonymous2MethodRef"})
public class StatusBarUtil {
    ...
    private static void setMIUIStatusBarDarkIcon(@NonNull Activity activity, boolean darkIcon) {
        ...
        try {
            ...
            Log.e("MIUIStatusBarDarkIcon", "setMIUIStatusBarDarkIcon: ", e);
        }
    }
    ...
    private static void setMeizuStatusBarDarkIcon(@NonNull Activity activity, boolean darkIcon) {
        try {
            ...
            Log.e("MeizuStatusBarDarkIcon", "setMeizuStatusBarDarkIcon: ", e);
        }
    }
