...
public class BasePermissionsFragment extends Fragment {
    public static final String TAG = "BasePermissionsFragment";
    ...
    private List<String> getPermissions(String[] permissions) {
        ...
        for (String permission : permissions) {
            if (ContextCompat.checkSelfPermission(Objects.requireNonNull(getActivity()), permission) !=
                    ...
                    ActivityCompat.shouldShowRequestPermissionRationale(Objects.requireNonNull(getActivity()), permission)) {
